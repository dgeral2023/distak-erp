...
initCustos(refresh);initOrcamentos();initFuncionarios(refresh);initFotografias();initDocumentos();initDiario();initAgenda(refresh);initPrevisoes(refresh);initDossies();initOperacional(refresh);initCompras(refresh);initMedicoes(refresh);initCampo(refresh);initV3();initHybridMenu({openCliente,openObra,openOrcamento,openCusto,openPagamento,openAgendaTask,openForecast,openOperationalQuick});initAssistant();initPwa();
