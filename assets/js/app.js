import {$,setView,esc} from "./core/ui.js";import {login,logout,session} from "./core/auth.js";import {store} from "./core/store.js";import {refreshData} from "./modules/data.js";import {renderDashboard} from "./modules/dashboard.js";import {renderClientes,openCliente,submitCliente,deleteCliente} from "./modules/clientes.js";import {renderObras,openObra,submitObra,deleteObra} from "./modules/obras.js";import {renderOrcamentos,openOrcamento,submitOrcamento,deleteOrcamento,initOrcamentos} from "./modules/orcamentos.js";import {renderCustos,openCusto,submitCusto,deleteCusto,initCustos} from "./modules/custos.js";import {renderPagamentos,openPagamento,submitPagamento,deletePagamento} from "./modules/pagamentos.js";import {renderFuncionarios,initFuncionarios} from "./modules/funcionarios.js";import {initFotografias} from "./modules/fotografias.js";import {initDocumentos} from "./modules/documentos.js";import {initDiario} from "./modules/diario.js";
async function refresh(){await refreshData();renderClientes();renderObras();renderOrcamentos();renderCustos();renderPagamentos();renderFuncionarios();renderDashboard();if(store.profile?.role==="funcionario")$("funcionarioObras").innerHTML=$("obrasTable").innerHTML}
...
initCustos(refresh);initOrcamentos();initFuncionarios(refresh);initFotografias();initDocumentos();initDiario();
