...
const meta={dashboard:["⌂","Início"],empresa:["⚙","Empresa"],clientes:["♙","Clientes"],obras:["▥","Obras"],operacional:["◉","Operacional"],agenda:["◫","Agenda"],dossies:["▧","Dossiês"],orcamentos:["▤","Orçamentos"],compras:["▦","Compras"],medicoes:["％","Medições"],custos:["↘","Custos"],pagamentos:["€","Pagamentos"],previsoes:["↗","Previsões"],funcionarios:["♟","Equipa"],relatorios:["▥","Relatórios"],funcionario:["✓","Meu painel"]};
...
function renderMore(){
  const views=store.profile?.role==="admin"?["operacional","agenda","dossies","clientes","orcamentos","compras","medicoes","custos","pagamentos","previsoes","funcionarios","relatorios","empresa"]:["operacional","agenda","dossies","funcionario"];
