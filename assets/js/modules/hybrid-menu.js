...
const meta={dashboard:["⌂","Início"],empresa:["⚙","Empresa"],clientes:["♙","Clientes"],obras:["▥","Obras"],operacional:["◉","Operacional"],agenda:["◫","Agenda"],dossies:["▧","Dossiês"],orcamentos:["▤","Orçamentos"],compras:["▦","Compras"],custos:["↘","Custos"],pagamentos:["€","Pagamentos"],previsoes:["↗","Previsões"],funcionarios:["♟","Equipa"],relatorios:["▥","Relatórios"],funcionario:["✓","Meu painel"]};
const adminViews=["clientes","orcamentos","compras","custos","pagamentos","previsoes","relatorios","funcionarios","empresa"];
let actions={};
...
function renderMore(){
  const views=store.profile?.role==="admin"?["operacional","agenda","dossies","clientes","orcamentos","compras","custos","pagamentos","previsoes","funcionarios","relatorios","empresa"]:["operacional","agenda","dossies","funcionario"];
