...
for(const required of ["labelDialog","labelControls","controlLabels","aria-modal","MutationObserver","_returnFocus","dialog[open]","event.key===\"Tab\"","focusable.at(-1)"])check(runtime.includes(required),`gestão acessível dos diálogos e controlos incompleta: ${required}`);
