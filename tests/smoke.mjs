...
const requiredIds = [
  ...
  ,"obraIvaTaxa", "obraIvaValorPreview", "obraTotalPreview", "obraFichaBase", "obraFichaIvaLabel", "obraFichaIva", "dashboardVatChart"
...
for (const required of ["distak-shell-v3.8-work-vat-rate-20260822-v1", "request.mode==='navigate'", "url.origin!==self.location.origin", "ignoreSearch:true", "async response", "await cache.put", "SHELL.map(async path", "fetch(path,{cache:'no-store'})", "['style','script','manifest'].includes", "fetch(request,{cache:'no-store'}).then(updateCache).catch", "assets/css/accessibility.css", "assets/css/client-access-management.css", "assets/css/cliente-approvals.css", "assets/css/backup.css", "assets/css/password-recovery.css", "assets/css/portal-content-management.css", "assets/css/role-validation.css", "assets/css/user-management.css", "assets/js/config.js", "assets/js/app.js", "assets/js/core/access-management.js", "assets/js/core/accessibility.js", "assets/js/core/assistant-local.js", "assets/js/core/backup-readiness.js", "assets/js/core/bootstrap-errors.js", "assets/js/core/data-quality.js", "assets/js/core/dossier-quality.js", "assets/js/core/field-queue.js", "assets/js/core/intelligence-actions.js", "assets/js/core/portal-publication.js", "assets/js/core/role-validation.js", "assets/js/core/supabase.js", "assets/js/core/work-finance.js", "assets/js/core/workload-analysis.js", "assets/js/modules/backup.js", "assets/js/modules/campo.js", "assets/js/modules/inteligencia.js", "assets/js/modules/portal-content-admin.js", "assets/js/modules/cliente-portal.js"]){
