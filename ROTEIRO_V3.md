...
Progresso: Centro de Acessos administrativo de leitura concluído, com inventário de contas, estados, perfis, obras atribuídas, vínculos de clientes, atividade recente, diagnóstico de inconsistências, notificações acionáveis e relatório local exportável. Recuperação segura de palavra-passe concluída no frontend, com resposta neutra, política forte e encerramento da sessão após a troca. Operações de convite ou mudança de permissão permanecem condicionadas à autorização específica.
