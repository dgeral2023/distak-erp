...
Progresso: Centro de Acessos administrativo de leitura concluído, com inventário de contas, estados, perfis, obras atribuídas, vínculos de clientes, atividade recente e diagnóstico de inconsistências. Operações de convite ou mudança de permissão permanecem condicionadas à autorização específica.
