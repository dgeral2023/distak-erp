const CACHE='distak-shell-v4.1-client';
const SHELL=['./','./index.html','./manifest.json','./icon.svg','./assets/css/style.css','./assets/css/dashboard-executivo.css','./assets/css/hybrid-menu.css','./assets/css/assistant.css','./assets/css/agenda.css','./assets/css/previsoes.css','./assets/css/dossies.css','./assets/css/operacional.css','./assets/css/compras.css','./assets/css/medicoes.css','./assets/css/campo.css','./assets/css/inteligencia.css','./assets/css/cliente-portal.css','./assets/js/core/field-queue.js','./assets/js/modules/campo.js','./assets/js/modules/inteligencia.js','./assets/js/modules/cliente-portal.js'];
